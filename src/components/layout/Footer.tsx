...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full bg-[#332F2F] bg-[#161111 opacity-20] text-white overflow-hidden font-nunito">
      {/* Background Elements */}
      ...
      <div className="container relative z-10 mx-auto px-6 py-16">
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 text-center text-sm text-gray-200">
          <p>
            &copy; {new Date().getFullYear()} PT AWA Construction. All rights
            reserved.
          </p>
        </div>
      </div>
