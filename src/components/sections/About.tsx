...
export default function About() {
  ...
  return (
    <section
      className="py-12 md:py-20 bg-(--color-background-secondary) overflow-hidden"
      id="about"
    >
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12 lg:gap-16">
          ...
          >
            ...
            <div className="bg-slate-200 border-l-4 border-(--color-primary) py-3 px-5 rounded-2xl w-fit">
              <span className="font-nunito font-bold text-gray-700 text-lg">{t.about.badge}</span>
            </div>
            ...
            <div className="font-nunito text-gray-600 text-base md:text-lg space-y-4 md:space-y-6">
              ...
              <p className="leading-relaxed">{t.about.closing}</p>
            </div>
          </motion.div>
