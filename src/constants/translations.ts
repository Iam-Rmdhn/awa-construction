...
export const TRANSLATIONS = {
  en: {
    ...
    chatbot: {
      greeting: {
        morning:
          "Good morning! I'm AWA Bot, ready to assist you. How can I help you today?",
        afternoon:
          "Good afternoon! I'm AWA Bot, ready to assist you. How can I help you today?",
        evening:
          "Good evening! I'm AWA Bot, ready to assist you. How can I help you today?",
      },
      initialMessage: "Hello, I'm AWA Assistant",
      responses: {
        greetingMorning:
          "Hello! Good morning, welcome to AWA Construction. How can I assist you?",
        greetingAfternoon:
          "Hello! Good afternoon, welcome to AWA Construction. How can I assist you?",
        greetingEvening:
          "Hello! Good evening, welcome to AWA Construction. How can I assist you?",
  ...
  id: {
    ...
    chatbot: {
      ...
      responses: {
        ...
        servicePrompt:
          "Berikut adalah layanan yang tersedia di AWA Construction:",
        defaultResponse:
  ...
  ja: {
    ...
    about: {
      ...
      closing:
        "細部へのこだわりと顧客満足を重視し、最高の結果を提供することをお約束します。",
    },
    services: {
      title: "私たちのサービス",
      subtitle:
        "初期計画から引き渡しまで、お客様の建設ニーズを満たす幅広いサービスを提供します",
      items: {
        design: {
          title: "設計と計画",
    ...
    footer: {
      companyDesc:
        "インドネシア全土で設計、建設、メンテナンスサービスを提供する大手建設会社。",
    ...
    chatbot: {
      greeting: {
        morning:
          "おはようございます！私はAWA Botです。本日はどのようにお手伝いいたしましょうか？",
        afternoon:
          "こんにちは！私はAWA Botです。本日はどのようにお手伝いいたしましょうか？",
        evening:
          "こんばんは！私はAWA Botです。本日はどのようにお手伝いいたしましょうか？",
      },
