...
import { ArrowLeft, User, Mail, Phone, Hammer, MapPin, Banknote, Lightbulb, LandPlot } from "lucide-react";
...
return (
    ...
    <div className="pt-24 pb-16 px-4 md:px-8">
        ...
        <motion.div 
            ...
            className="mb-12"
        >
            <h3 className="font-unbounded font-bold text-center text-lg mb-8">{t.consultation.contactInfo.title}</h3>
        ...
        >
            ...
            <div>
                <h3 className="font-unbounded font-bold text-lg mb-6 border-b pb-2">{t.consultation.form.title}</h3>
                <div className="grid md:grid-cols-2 gap-6">
                <div className="col-span-2">
                    <label className="font-nunito block text-sm font-medium text-gray-700 mb-2">{t.consultation.form.name}</label>
                ...
                <div>
                    <label className="font-nunito block text-sm font-medium text-gray-700 mb-2">{t.consultation.form.email}</label>
                    <div className="relative">
                        <input 
                            required
                            type="email" 
                ...
                <div>
                    <label className="font-nunito block text-sm font-medium text-gray-700 mb-2">{t.consultation.form.whatsapp}</label>
                    <div className="relative">
                        <input 
                            required
                            type="tel" 
            ...
            <div>
            <h3 className="font-unbounded font-bold text-lg mb-6 border-b pb-2">{t.consultation.project.title}</h3>
            <div className="grid md:grid-cols-2 gap-6">
                <div>
                    <label className="font-nunito block text-sm font-medium text-gray-700 mb-2">{t.consultation.project.type}</label>
                    <div className="relative">
                        <input 
                            type="text"
                            name="projectType"
                ...
                <div>
                    <label className="font-nunito block text-sm font-medium text-gray-700 mb-2">{t.consultation.project.location}</label>
                    <div className="relative">
                        <input 
                            type="text" 
                ...
                <div className="col-span-2">
                    <label className="font-nunito block text-sm font-medium text-gray-700 mb-2">{t.consultation.project.area}</label>
                    <div className="flex items-center gap-4">
                        ...
                        <span className="font-nunito text-sm text-gray-600 whitespace-nowrap">{t.consultation.project.unit}</span>
                    </div>
                </div>
            </div>
            </div>
            ...
            <div>
            <h3 className="font-unbounded font-bold text-lg mb-6 border-b pb-2">{t.consultation.preferences.title}</h3>
            <div className="grid md:grid-cols-2 gap-6">
                <div>
                    <label className="font-nunito block text-sm font-medium text-gray-700 mb-2">{t.consultation.preferences.budget}</label>
                    <div className="relative">
                        <input 
                            type="text" 
                            name="budget"
                ...
                <div>
                    <label className="font-nunito block text-sm font-medium text-gray-700 mb-2">{t.consultation.preferences.timeline}</label>
                    <div className="relative">
                        <input 
                            type="text" 
                            name="timeline"
